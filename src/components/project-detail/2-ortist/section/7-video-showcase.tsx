      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-20 grid grid-cols-12 gap-8">
          <div className={`col-span-12 md:col-span-5 md:col-start-2 transition-all duration-700 ${headerVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <p className="text-blue-500 uppercase tracking-widest mb-3 text-sm">Video Content</p>
            <h2 className="text-4xl font-light text-stone-900 mb-6 relative">
              Organic Strategies & Result Details
              <span className={`block absolute -bottom-2 left-0 h-px bg-blue-500 transition-all duration-700 delay-300 ${headerVisible ? 'opacity-100 w-16' : 'opacity-0 w-0'}`}></span>
            </h2>
          </div>
          <div className={`col-span-12 md:col-span-4 transition-all duration-700 delay-300 ${headerVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <p className="text-stone-600 font-light leading-relaxed">
              The best content that was really successful was a <strong>funny reel video</strong> that 
              <strong> encouraged</strong> people to visit Ortist Spesialist. Another viral video was 
              an <strong>educational video</strong> mixed with entertainment.
            </p>
          </div>
        </div>
