...
export default function Ortist() {
            ...
            {sectionTitles.map((title, i) => (
              ...
              >
                <div className={`w-4 h-4 rounded-full border ${
                  currentSection === i ? 'bg-blue-500 border-blue-500' : 'bg-white border-stone-300'
                } transition-all duration-300`}></div>
                <span className={`ml-4 text-xs font-medium uppercase tracking-widest ${
                  currentSection === i ? 'text-blue-500' : 'text-stone-400'
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-12 min-h-screen">
            ...
            <div className={`md:col-span-5 flex items-center p-8 md:pl-24 md:pr-12 relative transition-all duration-1000 ${sectionViewed[0] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <div className="space-y-8 max-w-md">
                <div className="space-y-4">
                  <div className={`inline-block py-1 px-2 border border-blue-500 text-blue-500 text-xs uppercase tracking-widest transition-all duration-700 delay-300 ${sectionViewed[0] ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'}`}>
                ...
                <div className={`pt-6 transition-all duration-700 delay-1000 ${sectionViewed[0] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                  ...
                  >
                    <span className="text-stone-900 group-hover:text-blue-500 transition-colors duration-300">View Case Study</span>
            ...
            <div className="md:col-span-7 grid grid-cols-12 grid-rows-6 h-screen">
              ...
              <div className={`col-span-6 row-span-2 relative bg-blue-500 transition-all duration-700 delay-300 ${sectionViewed[0] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="mb-16 grid grid-cols-1 md:grid-cols-12 gap-12">
              <div className={`md:col-span-4 transition-all duration-700 ${sectionViewed[1] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                <p className="text-blue-500 uppercase tracking-widest mb-3 text-sm">Expertise</p>
                <h2 className="text-4xl font-light text-stone-900 mb-6 relative">
                  Skills Applied
                  <span className={`block absolute -bottom-2 left-0 h-px bg-blue-500 transition-all duration-700 delay-300 ${sectionViewed[1] ? 'opacity-100 w-16' : 'opacity-0 w-0'}`}></span>
                </h2>
              </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-0.5">
              {brandData.skills.map((skill, index) => (
                ...
                >
                  <div className={`absolute inset-0 bg-blue-500 transition-all duration-0 ${hoveredSkill === index ? 'opacity-100' : 'opacity-0'}`}></div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="mb-16 grid grid-cols-1 md:grid-cols-12 gap-12">
              <div className={`md:col-span-4 transition-all duration-700 ${sectionViewed[3] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                <p className="text-blue-500 uppercase tracking-widest mb-3 text-sm">Impact</p>
                <h2 className="text-4xl font-light text-stone-900 mb-6 relative">
                  Campaign Results
                  <span className={`block absolute -bottom-2 left-0 h-px bg-blue-500 transition-all duration-700 delay-300 ${sectionViewed[3] ? 'opacity-100 w-16' : 'opacity-0 w-0'}`}></span>
                </h2>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-0.5 mb-16">
              {brandData.achievements.map((item, index) => (
                <div
                  key={index}
                  className={`group bg-white border border-stone-100 hover:border-blue-500 transition-all duration-700 ${sectionViewed[3] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
                  style={{ transitionDelay: `${4 + (index * 1)}ms` }}
                >
                  <div className="p-12 flex flex-col h-full min-h-64 justify-between">
                    <div className="text-5xl font-light text-stone-900 mb-6 transition-colors duration-300 group-hover:text-blue-500 flex items-center">
                      {sectionViewed[3] ? (
                        <>
                          <CountUp
                            start={0}
            ...
            <div className={`border-t border-stone-200 pt-16 transition-all duration-700 delay-700 ${sectionViewed[3] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-12">
                {brandData.results.map((result, index) => (
                  ...
                  >
                    <div className="mr-6 w-8 h-8 flex-shrink-0 border border-stone-200 flex items-center justify-center text-sm text-stone-400 group-hover:border-blue-500 group-hover:text-blue-500 transition-all duration-300">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="mb-16 grid grid-cols-1 md:grid-cols-12 gap-12">
              <div className={`md:col-span-4 transition-all duration-700 ${sectionViewed[5] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                <p className="text-blue-500 uppercase tracking-widest mb-3 text-sm">Creative Work</p>
                <h2 className="text-4xl font-light text-stone-900 mb-6 relative">
                  Design Gallery
                  <span className={`block absolute -bottom-2 left-0 h-px bg-blue-500 transition-all duration-700 delay-300 ${sectionViewed[5] ? 'opacity-100 w-16' : 'opacity-0 w-0'}`}></span>
                </h2>
              </div>
        ...
        >
          ...
          <div className="relative max-w-6xl w-full px-6 grid md:grid-cols-2 gap-24">
            <div className="flex flex-col justify-center">
              <p className={`text-blue-500 uppercase tracking-widest mb-3 text-sm transition-all duration-700 ${sectionViewed[6] ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>Next Case</p>
