          ...
          <div className="max-w-6xl mx-auto">
            <div className="mb-16 grid grid-cols-1 md:grid-cols-12 gap-12">
              <div className={`md:col-span-4 transition-all duration-700 ${sectionViewed[5] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                <p className="text-green-500 uppercase tracking-widest mb-3 text-sm">Creative Work</p>
                <h2 className="text-4xl font-light text-stone-900 mb-6 relative">
                  Design Gallery
                  <span className={`block absolute -bottom-2 left-0 h-px bg-green-500 transition-all duration-700 delay-300 ${sectionViewed[5] ? 'opacity-100 w-16' : 'opacity-0 w-0'}`}></span>
                </h2>
              </div>
