    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-12 min-h-screen">
        ...
        <div className={`md:col-span-5 flex items-center p-8 md:pl-24 md:pr-12 relative transition-all duration-1000 ${sectionViewed[0] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <div className="space-y-8 max-w-md">
            <div className="space-y-4">
              <div className={`inline-block py-1 px-2 border border-green-500 text-green-500 text-xs uppercase tracking-widest transition-all duration-700 delay-300 ${sectionViewed[0] ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-4'}`}>
              ...
              <h1 className={`text-6xl md:text-7xl font-light text-stone-900 leading-none transition-all duration-700 delay-500 ${sectionViewed[0] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
                ...
                <span className="relative inline-block">
                  <span className={`block absolute -bottom-2 left-0 w-16 h-1 bg-green-500 transition-all duration-700 delay-700 ${sectionViewed[0] ? 'opacity-100 w-16' : 'opacity-0 w-0'}`}></span>
                </span>
              </h1>
            ...
            <div className={`pt-6 transition-all duration-700 delay-1000 ${sectionViewed[0] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              ...
              >
                <span className="text-stone-900 group-hover:text-green-500 transition-colors duration-300">View Case Study</span>
        ...
        <div className="md:col-span-7 grid grid-cols-12 grid-rows-6 h-screen">
          ...
          <div className={`col-span-6 row-span-2 relative bg-green-500 transition-all duration-700 delay-300 ${sectionViewed[0] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
