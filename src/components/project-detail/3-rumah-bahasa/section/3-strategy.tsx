    ...
    <section ref={(el) => registerSection(el as HTMLDivElement | null, 2)} className="py-24 px-6 bg-stone-100">
        <div className="max-w-6xl mx-auto">
            <div className="mb-16 grid grid-cols-1 md:grid-cols-12 gap-12">
                ...
                <p className="text-green-500 uppercase tracking-widest mb-3 text-sm">Methodology</p>
                <h2 className="text-4xl font-light text-stone-900 mb-6 relative">
                    Campaign Strategy
                    <span className={`block absolute -bottom-2 left-0 h-px bg-green-500 transition-all duration-700 delay-300 ${sectionViewed[2] ? 'opacity-100 w-16' : 'opacity-0 w-0'}`}></span>
                </h2>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-0.5">
                ...
                >
                    <div className="absolute top-0 left-0 w-full h-px bg-stone-200 transition-all duration-300 group-hover:bg-green-500"></div>
                    <div className="absolute top-0 right-0 w-px h-full bg-stone-200 transition-all duration-300 group-hover:bg-green-500"></div>
                    <div className="absolute bottom-0 right-0 w-full h-px bg-stone-200 transition-all duration-300 group-hover:bg-green-500"></div>
                    <div className="absolute bottom-0 left-0 w-px h-full bg-stone-200 transition-all duration-300 group-hover:bg-green-500"></div>
                    
                    <div className="p-8 flex flex-col h-full min-h-64">
                    <div className="text-5xl font-light text-stone-200 mb-6 transition-colors duration-300 group-hover:text-green-200">
