        ...
        <div className="mb-16 grid grid-cols-1 md:grid-cols-12 gap-12">
          ...
          >
            <motion.p 
              ...
              className="text-red-500 uppercase tracking-widest mb-3 text-sm"
            >
              Method
            </motion.p>
            ...
            <motion.h2 
              ...
              <span className={`block absolute -bottom-2 left-0 h-px bg-red-500 transition-all duration-700 delay-300 ${isInView ? 'opacity-100 w-16' : 'opacity-0 w-0'}`}></span>
            </motion.h2>
          </motion.div>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="flex flex-row justify-center items-stretch gap-6 md:gap-10 overflow-visible">
              {brandData.marketingMethod.steps.map((step, index) => (
                ...
                >
                  {/* Top Corner Accent */}
                  <div className="absolute -top-10 -right-10 w-20 h-20 bg-red-50 opacity-0 
                  ...
                  <div className="bg-white p-8 h-full flex flex-col rounded-lg relative
                                ...
                                after:border after:border-red-300 after:scale-105 after:opacity-0
                                group-hover:after:scale-100 group-hover:after:opacity-100
                                after:transition-all after:duration-700">
                    
                    {/* Step Number */}
                    <div className="inline-flex items-center mb-6">
                      <span className="text-4xl font-extralight text-red-400 mr-2 transition-all duration-500
                                      group-hover:text-red-500">{index + 1}</span>
                      <div className="h-px w-0 bg-red-200 transition-all duration-700 group-hover:w-16"></div>
                    </div>
