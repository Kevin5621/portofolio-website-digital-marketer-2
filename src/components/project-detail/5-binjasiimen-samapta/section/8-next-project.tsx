    ...
    >
      ...
      <div className="relative max-w-6xl w-full px-6 grid md:grid-cols-2 gap-24">
        <div className="flex flex-col justify-center md:order-1">
          <p className={`text-red-500 md:text-red-500 uppercase tracking-widest mb-3 text-sm transition-all duration-500 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-8'}`}>Next Case</p>
          ...
          >
            <span className="text-white md:text-stone-900 group-hover:text-red-500 transition-colors duration-300">Ortist Specialist</span>
            <span className="ml-3 w-8 h-px bg-white md:bg-stone-900 group-hover:w-12 group-hover:bg-red-500 transition-all duration-300"></span>
          </Link>
        </div>
