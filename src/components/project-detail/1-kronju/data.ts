...
export const brandData = {
  ...
  description: "A premium cheese snack brand made from tapioca flour and real cheese.",
  ...
  results: [
    "The client loved the final designs, and there were very few changes needed.",
    "The designs showed the healthy and fun side of the brand, making people feel good about the product."
  ],
